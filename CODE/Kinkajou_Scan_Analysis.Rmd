...
all_kinkajou_scans_long <- read.csv("../DATA/processed/all_kinkajou_scans.csv")[,-1]
...
decisions <- mutate(decisions, Success = relative_density_diff > 0, 
                    ...
                    Success_Social = kink_counts_to - kink_counts_avoid > 0,
...
```{r solo bout reference model 1 extraction}
