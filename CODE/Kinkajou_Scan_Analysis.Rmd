...
flower_counts <- all_upflowers %>% 
  ...
  mutate(Density = as.numeric(Count/(sum(st_area(region_shapes)))))
...
flower_counts_region <- flower_counts_region %>% mutate(Density = as.numeric(Count/(st_area(region_shapes)[Region]))) #divide flower count by area of region to get flower density
```
