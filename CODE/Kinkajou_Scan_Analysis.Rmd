...
residence_time_all_regression <- lm(data = combined_data, formula = Minutes_Per_Hour ~ Study_night + Count)
summary(residence_time_all_regression)

Sres <- sqrt(sum(residence_time_all_regression$residuals ^ 2)/(length(residence_time_all_regression$residuals) - 2))
plot(residence_time_all_regression$residuals)
qqnorm(residence_time_all_regression$residuals/Sres)
```
